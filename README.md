...
```bash
$ yarn add @ongojs/http-controller 
...
```bash
 const Base = require('@ongojs/http-controller');
 const base = new Base();
 base.apiGet();
...
or 
```bash
 class MyWonderfulClass extends require('@ongojs/http-controller') {
